...
export default function AddColumnButton({
  ...
  return (
    <div className="flex flex-col h-full min-w-[280px] w-80">
      <button
        onClick={onClick}
        className="w-full h-8 rounded-xl border-2 border-dashed border-spotlight-purple/50 hover:border-spotlight-purple bg-background-primary/30 hover:bg-background-primary/50 text-spotlight-purple hover:text-text-primary transition-all duration-200 cursor-pointer font-display font-medium text-sm flex items-center justify-center gap-2 hover:shadow-glow-purple/20"
      >
        <FiPlus size={16} />
        Add Column
      </button>
